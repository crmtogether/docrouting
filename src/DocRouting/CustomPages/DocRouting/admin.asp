...
content.contents += '<td valign="TOP"><span id="_CaptSMTPServer" class="VIEWBOXCAPTION">Outgoing mail server (SMTP):</span><br>' +
		'<span id="_DataSMTPServer" class="VIEWBOX"><input type="text" class="EDIT" id="SMTPServer" name="SMTPServer" value="'+SMTPServer+'" maxlength="50" size="25"></td>';
...
content.contents += '<td valign="TOP"><span id="_CaptSMTPPort" class="VIEWBOXCAPTION">SMTP port:</span><br><span id="_DataSMTPPort" class="VIEWBOX">' + 
					'<input type="text" class="EDIT" id="SMTPPort" name="SMTPPort" value="'+SMTPPort+'" maxlength="50" size="10"></span></td>';
content.contents += '<td><span class="VIEWBOXCAPTION" id="_CaptUseSecureSMTP"><label for="_IDUseSecureSMTP">Use TLS for SMTP</label>:</span>' + 
					'<br><span class="VIEWBOXCAPTION" id="_DataUseSecureSMTP"><input type="checkbox" name="UseSecureSMTP" checked="'+UseSecureSMTP+'" id="_IDUseSecureSMTP"></span></td>';
content.contents += '</tr>';
content.contents += '<tr>';
...
content.contents += '<input type="text" class="EDIT" id="SMTPUserName" name="SMTPUserName" value="'+SMTPUserName+'" maxlength="50" size="25"></span></td>';
